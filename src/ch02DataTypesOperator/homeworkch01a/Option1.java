...
Мы используем объект Scanner для ввода данных с консоли.
Создаем массив sourceNumbers для хранения введенных пользователем чисел.
В цикле for заполняем массив введенными числами.
Инициализируем переменные minLength и maxLength для хранения длин самого короткого и
самого длинного числа соответственно.
Внутри цикла for проходим по всем числам массива, определяем длину каждого числа (игнорируя
знак), и обновляем переменные, если находим более короткое или длинное число.
В конце выводим самое короткое и самое длинное числа вместе с их длинами.*/